...
function lapizzeria_agregarCamposRestApi()
{
    register_rest_field(
        'especialidades',
        'precio',
        array(
            'get_callback' => 'lapizzeria_obtenerPrecio',
    ...
    register_rest_field(
        ...
        'categoria-menu',
        array(
            'get_callback' => 'lapizzeria_taxonomiaMenu',
            'update_callback' => null,
            'schema' => null
        )
    );
    register_rest_field(
        ...
        'imagen_destacada',
        array(
            'get_callback' => 'lapizzeria_imagenDestacada',
            'update_callback' => null,
            'schema' => null
        )
    );
}
add_action('rest_api_init', 'lapizzeria_agregarCamposRestApi');

function lapizzeria_obtenerPrecio()
{
...
function lapizzeria_taxonomiaMenu(){
    global $post;
    return get_object_taxonomies($post);
}

function lapizzeria_imagenDestacada($object, $field_name, $request){
