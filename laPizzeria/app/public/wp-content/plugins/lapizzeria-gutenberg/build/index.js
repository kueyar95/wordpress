...
registerBlockType("lapizzeria/menu", {
  ...
  edit: withSelect((select, props) => {
    ...
    const onChangeCantMostrar = newCant => {
      setAttributes({
        cantidadMostrar: parseInt(newCant)
      });
    };

    const onChangeCategoriaMenu = newCateg => {
      setAttributes({
        categoriaMenu: parseInt(newCateg)
      });
    };

    const onChangeTituloBloque = newTitle => {
      setAttributes({
        tituloBloque: newTitle
      });
    };
    ...
    console.log(categorias); //Extraer valores
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelBody, {
      ...
      className: "components-base-control__label"
    }, "Categoria de Especialidad"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(SelectControl, {
