...
function gymfitness_clases_post_type() {
	...
	$args = array(
		...
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true, //visible en el menú lateral
        'menu_position'         => 6,
        'menu_icon'             => 'dashicons-welcome-learn-more', //dash icon son los íconos que usa wp para el menú lateral
		'show_in_admin_bar'     => true, //visible en la barra superior que se ve en el sitio cuando estás logueado
		'show_in_nav_menus'     => true, //habilita la posibilidad de añadirlo en la sección del menú
		'can_export'            => true,
		'has_archive'           => true,
